...
using rducc.rabl.webapi.Providers;
using rducc.rabl.webapi.Results;
...
namespace rducc.rabl.webapi.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        //RDUCC
        //http://code.msdn.microsoft.com/OWIN-Bearer-Token-d5eeecc2#content
        [HttpPost]
        [AllowAnonymous]
        [Route("Token")]
        public HttpResponseMessage Token(LoginBindingModel login)
        {
            ...
            if (login.Username == "derek" && login.Password == "pass")
            {
        ...
        {
            //this method will force a 401 Unauthorized message if the user is not logged in.
            return new HttpResponseMessage(HttpStatusCode.OK)
            {
                Content = new ObjectContent<object>(new
                    {
